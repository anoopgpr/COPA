...
var json_fb='https://taghash.co/mloyalApps/facebookcopa.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=copa';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinteresttantra.php?brand=copa';
var RSS_instagram='https://www.instagram.com/copa/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=copa';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://copa.tumblr.com';

var brandname='copa';
var aboutus_det='copa';
var brand_url='https://www.copa.com/';
var cart = { cartdata: []};
...
var SERVER = "https://copa.mloyalretail.com/m/";
var SERVER1 = "https://copa.mloyalretail.com/";
...
$(document).ready(function(event){
			   ...
			   if($.mobile.activePage.is('#homepage')){
                 ...
                 //getContacts();
                  if(localStorage.getItem("usernamecopa")!=null && localStorage.getItem("usernamecopa")!='' && localStorage.getItem("passwordcopa")!=null && localStorage.getItem("passwordcopa")!='')
                    {
                            $('#username').val(localStorage.getItem("usernamecopa"));
                            $('#password_myacc').val(localStorage.getItem("passwordcopa"));
							user.mobile = localStorage.getItem('usernamecopa');
							var pwd = localStorage.getItem('passwordcopa');
							...
							user.slab_id_copa = localStorage.getItem('slab_id_copa');
                        ...
                        if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
                                user.mobile = '';
					    if(user.slab_id_copa=='undefined' || user.slab_id_copa=='null' || user.slab_id_copa==null || user.slab_id_copa=='')
								user.slab_id_copa = '1';
                           // alert(user.firstname);
                            ...
                            document.getElementById("profilepts1").innerHTML=user.total+' points';
                             ...
                             $("#wait").css("display","none");
                             authenticate();
                          if(imageExists('https://taghash.co/mloyalfileupload/uploads/copa_'+localStorage.getItem("usernamecopa")+'.jpg'))
                          {
                              document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/copa_'+localStorage.getItem("usernamecopa")+'.jpg';
                          }                     
                     }
				   else if(localStorage.getItem("usernamecopa")!=null && localStorage.getItem("usernamecopa")!='' && (localStorage.getItem("passwordcopa")==null || localStorage.getItem("passwordcopa")=='')) 
	                 {
			...
			success: function(data, textStatus, xhr) {
			 ...
			 if(data.toLowerCase()=='success'){
				 ...
				 $('#login-msg').html('The  passcode has been sent to your mobile.Please check your SMS.');
			      ...
			      $('#username').val(mob);
				  localStorage.setItem('usernamecopa',mob);
...
function authenticate(){
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   if(data.status=='success'){
	...
	user.slab_id_copa = data.Slab_id;
   ...
   localStorage.setItem('usernamecopa',uname);
   localStorage.setItem('passwordcopa',pwd);
   ...
   localStorage.setItem('slab_id_copa',user.slab_id_copa);
 ...
 if(user.slab_id_copa=='undefined' || user.slab_id_copa=='null' || user.slab_id_copa==null || user.slab_id_copa=='')
    ...
    {
	    if(localStorage.getItem("profiledone_copa")){
    ...
    error: function(xhr, textStatus, errorThrown) {
	user.mobile = localStorage.getItem('usernamecopa');
	pwd = localStorage.getItem('passwordcopa');
	uname = user.mobile;
    user.balance = localStorage.getItem('balance');
    user.firstname = localStorage.getItem('firstname');
    user.lastname = localStorage.getItem('lastname');
...
$(document).on('pageinit', '#profilepage', function (event, ui) {
	...
	$.ajax({
			...
			success: function(data, textStatus, xhr) {
				...
				localStorage.setItem("profiledone_copa","Yes");
...
function showRewards(){
	...
	openInWebView('https://copa.mloyalretail.com/microsite/');
	//RewardsNA();
	/*
	if(user.mobile==null || user.mobile=='')
	{
...
if(id=='rewardstore' || id=='reward-cat' || id=='reward-brand')
	{
	tabserver = "https://copa.mloyalretail.com/Rewards/";
	}
else
	{
	
	tabserver = "https://copa.mloyalretail.com/m/";
	}
	$.getJSON(
		tabserver+url, {
		//page: url,
...
function renderTemplate(pageID, json) {
	...
	case 'inbox':
        ...
        str += '<span class="msghdr">DM-COPA</span><span class="msgTime">'+json[i].msgtime+'</span>';
...
var str = '';
	...
	switch (pageID) {
		...
		case 'aboutus':
			...
			if(parseInt(user.slab_id_copa)==1 || parseInt(user.slab_id_copa)==2)
            {
            ...
            else if(parseInt(user.slab_id_copa)==3)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
            ...
            else if(parseInt(user.slab_id_copa)==4)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_copa',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_copa')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_copa',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_copa')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_copa', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_copa')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_copa',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_copa')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_copa',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_copa')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_copa',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_copa')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "1048260382577"}});
...
function addincart(i)
{
	...
	cart.cartdata.push({ 
   "index":i,
   "url" : "https://copa.mloyalretail.com/"+jsonary[i].brand_logo,
...
function checkout(){
  ...
  $.ajax({
    url: 'https://copa.mloyalretail.com/Rewards/complete.asp',
    type: 'GET',
    timeout: 50000,
...
function giftfriend(){
  ...
  var val=$('#giftpt').val();
  $.ajax({
    url: 'https://copa.mloyalretail.com/m/gift_points_api.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
	window.plugins.socialsharing.share('Hi, Join COPA Stores Club.', null, 'https://taghash.co/shareimg/copa.jpg', 'https://copa.mloyalretail.com/mapp');
}
...
function rateApp()
{
	var deviceType = (navigator.userAgent.match(/iPad/i))  == "iPad" ? "iPad" : (navigator.userAgent.match(/iPhone/i))  == "iPhone" ? "iPhone" : (navigator.userAgent.match(/Android/i)) == "Android" ? "Android" : (navigator.userAgent.match(/BlackBerry/i)) == "BlackBerry" ? "BlackBerry" : "null";
		 if (deviceType=='iPad' || deviceType=='iPhone') 
			 ...
			 {
               window.open("market://details?id=com.mobiquest.copa","_system");
...
function showShop()
{
    openInWebView('https://www.copa.com/');
	//$.mobile.changePage( "#menupg", { transition: "none"} );
	//var url='https://www.copa.com/';
...
$("input[type=file]").change(function(){
  ...
  // alert($("input[type=file]")[0].files[0]);
	...
	aFormData.append("mobile", localStorage.getItem("usernamecopa"));
    aFormData.append("brand", "copa");
	...
	$.ajax(
    {
      ...
      success     : 
        function(data)
        {
         ...
         document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/copa_'+localStorage.getItem("username")+'.jpg';
      //   document.getElementById("cardImage").src='https://taghash.co/mloyalfileupload/uploads/copa_'+localStorage.getItem("username")+'.jpg';
        }
    });
...
function onPhotoDataSuccessnew(imageURI) 
{
				...
				var fName ='copa_'+localStorage.getItem("usernamecopa");
...
function failnew()
{
	toast("An error occurred: Code = " + error.code);
